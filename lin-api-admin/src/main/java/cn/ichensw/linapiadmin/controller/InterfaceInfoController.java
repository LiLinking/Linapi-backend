package cn.ichensw.linapiadmin.controller;

import cn.hutool.json.JSONUtil;
import cn.ichensw.linapiadmin.annotation.AuthCheck;
import cn.ichensw.linapiadmin.config.GatewayConfig;
import cn.ichensw.linapiadmin.exception.BusinessException;
import cn.ichensw.linapiadmin.exception.ThrowUtils;
import cn.ichensw.linapiadmin.service.InterfaceInfoService;
import cn.ichensw.linapiadmin.service.UserService;
import cn.ichensw.linapicommon.common.*;
import cn.ichensw.linapicommon.constant.CommonConstant;
import cn.ichensw.linapicommon.constant.UserConstant;
import cn.ichensw.linapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import cn.ichensw.linapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import cn.ichensw.linapicommon.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import cn.ichensw.linapicommon.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import cn.ichensw.linapicommon.model.entity.InterfaceInfo;
import cn.ichensw.linapicommon.model.entity.User;
import cn.ichensw.linapicommon.model.enums.InterfaceInfoStatusEnum;
import cn.ichensw.linapicommon.model.vo.InterfaceInfoVO;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        LinApiClient linApiClient = interfaceInfoService.getLinApiClient(request);
        // 设置网关地址
        linApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = linApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = linApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
